...
export default function NotificationsExample() {
  ...
  return (
    <div className="flex-column align-center ">
      <h2 className="mb-2 text-2xl">Notifications</h2>
      <p>
        This example is demonstrates how to use the notification system within
        Nexth.
      </p>
      ...
      <div className="mt-4 flex flex-wrap gap-4">
        <button
          ...
          onClick={() => Add('Transaction sent..', { type: 'info' })}
        >
          Info
        </button>
        <button
      ...
      <div className="mt-4">
        <h3 className="mb-4 text-lg">{notifications.length} Notification(s)</h3>
