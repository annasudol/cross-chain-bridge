...
const tokenIcons: Record<TokenSymbol | ChainName, string> = {
  ...
  [TokenSymbol.wstETH]: '/assets/wstETH.svg',
  [ChainName.Sepolia]: '/assets/ETH.svg',
};
  ...
  if (
    ...
    return (
      <div
        ...
        className={cn(
          'flex items-center justify-center rounded-full border-2 border-gray-700 bg-gray-100',
          className,
        )}
      >
